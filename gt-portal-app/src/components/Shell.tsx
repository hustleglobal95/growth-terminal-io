...
const ICONS: Record<string, string> = {
  ...
  Guide: '<path d="M2.5 3.5h5a2 2 0 0 1 2 2v9a1.6 1.6 0 0 0-1.6-1.6H2.5z"/><path d="M15.5 3.5h-5a2 2 0 0 0-2 2v9a1.6 1.6 0 0 1 1.6-1.6h5.4z"/>',
...
const GROUPING: [string, string[]][] = [
  ...
  /* The guide sits on its own rather than inside Setup. Somebody reaching
     for it is stuck, and making them scan a group called Setup to find help
     is the wrong moment to ask for patience. */
  ['Help', ['Guide']]
]
